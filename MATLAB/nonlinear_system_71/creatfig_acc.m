function creatfig_acc(X1, Y1, X2, Y2)
%CREATFIG_ ACC(X1,Y1,X2,Y2)
%  X1:  vector of x data
%  Y1:  vector of y data
%  X2:  vector of x data
%  Y2:  vector of y data
...
% Create plot
plot(X1,Y1,'Parent',axes1,'LineWidth',1.0,'DisplayName','EC acceleration');

% Create plot
plot(X2,Y2,'Parent',axes1,'LineWidth',1.4,'DisplayName','upp');
