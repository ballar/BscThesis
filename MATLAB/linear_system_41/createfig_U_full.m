function  createfig_U_full(X1, YMatrix1, integration_algorithm)
%CREATEFIG_U_FULL (X1,YMATRIX1)
%  X1:  vector of x data
...
set(plot1(1),'LineWidth',2.0,'DisplayName','U_{full,1}');
set(plot1(2),'LineWidth',2.0,'DisplayName','U_{full,2}');
set(plot1(3),'LineWidth',2.0,'DisplayName','U_{full,3}');
set(plot1(4),'LineWidth',2.0,'DisplayName','U_{full,4}');
set(plot1(5),'LineWidth',2.0,'DisplayName','U_{full,5}');
