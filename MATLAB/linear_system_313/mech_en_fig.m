function mech_en_fig(X1, YMatrix1, integration_algorithm)
...
'Name','A 3.1.3  feladat mechanikai energiája',...
...
set(plot1(1),'LineWidth',2.0,'DisplayName','ME');
% set(plot1(2),'LineWidth',2.0,'DisplayName','ME(2)');
...
set(legend1,'Orientation','horizontal','Location','NorthWest');
