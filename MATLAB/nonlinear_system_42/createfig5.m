function  createfig5(X1, YMatrix1, integration_algorithm)
...
set(plot1(1),'LineWidth',2.0,'DisplayName','U(5)');
% set(plot1(2),'LineWidth',2.0,'DisplayName','U_2');
set(plot1(2),'LineWidth',0.3,'DisplayName','K^{-1}q(5)');
% set(plot1(2),'LineWidth',0.3,'Color',[0 0.749019622802734 0.749019622802734],...
% 'DisplayName','K^{-1}q(2)');
