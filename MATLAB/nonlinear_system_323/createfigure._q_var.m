...
set(plot1(1),'LineWidth',2.0,'DisplayName','U_{10}(1)');
set(plot1(2),'LineWidth',2.0,'DisplayName','U_{10}(2)');
set(plot1(3),'LineWidth',2.0,'DisplayName','U_{20}(1)');
set(plot1(4),'LineWidth',2.0,'DisplayName','U_{20}(2)');
set(plot1(5),'LineWidth',2.0,'DisplayName','U_{40}(1)');
set(plot1(6),'LineWidth',2.0,'DisplayName','U_{40}(2)');
set(plot1(7),'LineWidth',2.0,'DisplayName','U_{80}(1)');
